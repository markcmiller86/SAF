...
typedef struct SAF_DbProps SAF_DbProps;

/*---------------------------------------------------------------------------------------------------------------------------------
 * Audience:    Public
 * Chapter:    	Database Properties
 * Purpose:     Default properties
 *
 * Description:	Identifiers for default properties for databases.
 *---------------------------------------------------------------------------------------------------------------------------------
 */
#define SAF_DEFAULT_DBPROPS	NULL	/* value to pass to saf_open_database() to specify default behavior */
