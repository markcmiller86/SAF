...
typedef struct 
{
  ...
  SAF_Cat m_cat;
  SAF_Set *m_sets; 
  int **m_transform;/*XXX what's the right word for this?*/
} struct_subset_transform;
...
int read_field_from_subset(
			   ...
			   SAFStrMeshReader *a_strReader,
#endif
			   SAF_Field a_field, SAF_Set a_subset, struct_subset_transform a_subsetList, 
			   MY_PRECISION **a_data, int **a_truth );
