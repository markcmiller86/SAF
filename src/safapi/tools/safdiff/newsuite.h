...
/*this version lets you filter by number of components*/
int find_field_tmpls_new(SAF_ParMode pmode,
                          ...
                          int num_comp,   /* the returned field templates must have this many component fields, new feature*/
                          int *Pnum_ftmpls,
                          SAF_FieldTmpl *Pftmpls);

/*this version actually *returns* the component field templates*/
